...
@if(Request::secure())
    <!-- Styles -->
        ...
        <script src="{{ secure_asset('vendor/pace/pace.min.js') }}" data-pace-options='{ "ajax": { "ignoreURLs": ["notification", "ordersr", "markAllSeen"]} }'></script>
    ...
    <!-- Styles -->
        ...
        <script src="{{ asset('vendor/pace/pace.min.js') }}" data-pace-options='{ "ajax": { "ignoreURLs": ["notification", "ordersr", "markAllSeen"]} }'></script>
    @endif
</head>
<body>
<div id="app">
